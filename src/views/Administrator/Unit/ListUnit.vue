        ...
        <div class="card">
          <div class="card-header">
            ...
            <p class="card-title-desc">
              Berikut adalah daftar unit yang terdaftar di aplikasi.
            </p>
          </div>
          <div class="card-body">
            <div class="row mb-3">
              ...
              <div class="col-md-auto">
                <div class="input-group">
                  <input type="text" v-model="searchQuery" class="form-control" placeholder="Cari Unit">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                  <tr v-for="(unit, index) in filteredUnits" :key="unit.id">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="text" v-model="newUnitName" class="form-control" placeholder="Nama Unit">
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
            <button type="button" class="btn btn-primary" @click="addUnit">Simpan</button>
          </div>
        </div>
      </div>
    </div>
